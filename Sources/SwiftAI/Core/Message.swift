...
///   UserMessage(text: "What's the weather today?"),
...
public protocol Message: Sendable {
  ...
  ///
  /// A message can contain multiple chunks of different types, allowing for rich content
  /// that combines several modalities.
...
public enum Role: Sendable {
  ...
  /// Requests from the AI to execute a specific tool or function.
  case toolCall
...
public enum ContentChunk: Sendable {
  /// Plain text content.
  case text(String)

  // TODO: Add other chunk types.
}

// MARK: - Basic Message Implementations

/// A system message that defines AI behavior and constraints.
public struct SystemMessage: Message {
